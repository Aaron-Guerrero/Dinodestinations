...
<body>
    <header class="header">
        <img src="./images/dd_logo.png" alt="Dino Destinations" class="center">
        <p>Find dinosaur museums near you!</p>
    </header>

    <div class="tab-container">
        <button class="tab" id="loginTab" onclick="openTab(event, 'Login')">Login</button>
